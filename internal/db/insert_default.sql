...
INSERT INTO users (uuid, email, password, is_central_authority) VALUES
(uuidv7(), 'admin@sentinelvote.tech', argon2id('password'), TRUE);
...
SELECT
	...
	(SELECT generate_private_key()           WHERE x != 0)
FROM seq;